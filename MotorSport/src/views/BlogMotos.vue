...
export default {
  ...
  data() {
    return {
        cards: [
                { id: 1, title: 'DUCATI', description: ' turbodiésel V6 3.0L que rinde unos 623Nm de par motor, un motor HEMI 392 de 505CV y el todopoderoso HEMI 6.2 Supercharged Hellcat de 800CV. Toda esa potencia se entrega a las 4 o 6 ruedas', image: JeepGladiatorImage },
                ...
                { id: 4, title: 'CBR 600 RR', description: 'El Mustang GT Premium es un icono de potencia y estilo de Ford. Con un motor V8 de alto rendimiento, ofrece una experiencia de conducción emocionante y un interior lujoso con características premium, fusionando el legado del Mustang con la modernidad.', image: camaro },
                { id: 5, title: 'YAMAHA R1', description: 'El Ford Mustang es un legendario automóvil deportivo estadounidense, reconocido por su diseño clásico y su potente rendimiento. Desde su debut en 1964, ha sido un ícono cultural y un símbolo de libertad y estilo.', image: camaro2 },
                { id: 6, title: 'DUCATI HYPERMOTARD', description: 'El R34 Skyline, un legendario automóvil deportivo japonés fabricado por Nissan, destaca por su diseño aerodinámico y su potente motor turbocharged. Es famoso por su rendimiento excepcional y su estatus icónico en la cultura automotriz.', image: skyline },
